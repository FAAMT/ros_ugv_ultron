...
echo_and_run cd "/home/ubuntu/ros_ugv_ultron/ultron_ws/src/navigation/base_local_planner"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ubuntu/ros_ugv_ultron/ultron_ws/src/navigation/base_local_planner/setup.py" \
     \
    build --build-base "/home/ubuntu/ros_ugv_ultron/ultron_ws/build/navigation/base_local_planner" \
    install \
    --root="${DESTDIR-/}" \
