...
get_filename_component(_filename "/home/ubuntu/ros_ugv_ultron/ultron_ws/src/demos/dnn_rotate/srv/StringTrigger.srv" NAME_WE)
add_custom_target(_dnn_rotate_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dnn_rotate" "/home/ubuntu/ros_ugv_ultron/ultron_ws/src/demos/dnn_rotate/srv/StringTrigger.srv" ""
)
...
_generate_srv_cpp(dnn_rotate
  "/home/ubuntu/ros_ugv_ultron/ultron_ws/src/demos/dnn_rotate/srv/StringTrigger.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dnn_rotate)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dnn_rotate\")")
  # install generated code
  install(
