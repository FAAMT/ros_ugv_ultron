...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/faamt/ros_ugv_ultron/src/rosserial/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/faamt/ros_ugv_ultron/devel)
  ...
  set(rosserial_windows_INSTALL_PREFIX /home/faamt/ros_ugv_ultron/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faamt/ros_ugv_ultron/src/rosserial/rosserial_windows/${idir}'.  ${_report}")
    endif()
