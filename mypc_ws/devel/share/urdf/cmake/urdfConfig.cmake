...
if("TRUE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /home/faamt/ros_uv_ultron/src/urdf)
  set(urdf_DEVEL_PREFIX /home/faamt/ros_uv_ultron/devel)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /home/faamt/ros_uv_ultron/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faamt/ros_uv_ultron/src/urdf/${idir}'.  ${_report}")
    endif()
