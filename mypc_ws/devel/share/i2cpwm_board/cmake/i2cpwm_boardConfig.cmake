...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/faamt/ros_uv_ultron/src/ros_tutorials/ros-i2cpwmboard)
  set(i2cpwm_board_DEVEL_PREFIX /home/faamt/ros_uv_ultron/devel)
  ...
  set(i2cpwm_board_INSTALL_PREFIX /home/faamt/ros_uv_ultron/install)
...
if(NOT "/home/faamt/ros_uv_ultron/devel/include " STREQUAL " ")
  set(i2cpwm_board_INCLUDE_DIRS "")
  set(_include_dirs "/home/faamt/ros_uv_ultron/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faamt/ros_uv_ultron/src/ros_tutorials/ros-i2cpwmboard/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/faamt/ros_uv_ultron/devel/lib;/home/faamt/ros_uv_ultron/devel/lib;/opt/ros/kinetic/lib)
