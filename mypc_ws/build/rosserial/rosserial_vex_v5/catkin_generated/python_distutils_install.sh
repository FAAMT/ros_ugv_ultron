...
echo_and_run cd "/home/faamt/ros_ugv_ultron/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/faamt/ros_ugv_ultron/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/faamt/ros_ugv_ultron/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
