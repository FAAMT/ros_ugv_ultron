...
echo_and_run cd "/home/faamt/ros_ugv_ultron/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/faamt/ros_ugv_ultron/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/faamt/ros_ugv_ultron/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
