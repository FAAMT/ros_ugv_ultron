...
echo_and_run cd "/home/faamt/ros_ugv_ultron/src/joint_state_publisher/joint_state_publisher"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/faamt/ros_ugv_ultron/src/joint_state_publisher/joint_state_publisher/setup.py" \
     \
    build --build-base "/home/faamt/ros_ugv_ultron/build/joint_state_publisher/joint_state_publisher" \
    install \
    --root="${DESTDIR-/}" \
