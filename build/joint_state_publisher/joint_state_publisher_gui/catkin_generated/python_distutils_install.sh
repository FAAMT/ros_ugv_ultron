...
echo_and_run cd "/home/faamt/ros_ugv_ultron/src/joint_state_publisher/joint_state_publisher_gui"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/faamt/ros_ugv_ultron/src/joint_state_publisher/joint_state_publisher_gui/setup.py" \
     \
    build --build-base "/home/faamt/ros_ugv_ultron/build/joint_state_publisher/joint_state_publisher_gui" \
    install \
    --root="${DESTDIR-/}" \
