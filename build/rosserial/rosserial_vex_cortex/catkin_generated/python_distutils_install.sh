...
echo_and_run cd "/home/faamt/ros_ugv_ultron/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/faamt/ros_ugv_ultron/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/faamt/ros_ugv_ultron/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
