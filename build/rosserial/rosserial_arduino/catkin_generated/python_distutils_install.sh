...
echo_and_run cd "/home/faamt/ros_ugv_ultron/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/faamt/ros_ugv_ultron/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/faamt/ros_ugv_ultron/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
